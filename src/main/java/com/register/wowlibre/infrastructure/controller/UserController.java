...
public class UserController {
        ...
        @Operation(summary = "Create new user account", description = "Creates a new user account and returns JWT authentication tokens")
        @ApiResponses({
        ...
        @Operation(summary = "Check user existence", description = "Checks if a user exists by email or cell phone.")
        @ApiResponses({
        ...
        @GetMapping
        @Operation(summary = "Get user details", description = "Returns the user profile for the given user id.")
        @ApiResponses({
        ...
        @Operation(summary = "Confirm email code", description = "Validates the email confirmation code for the account.")
        @ApiResponses({
        ...
        @Operation(summary = "Request password recovery code", description = "Sends a password recovery code to the provided email.")
        @ApiResponses({
        ...
        @Operation(summary = "Confirm recovery code and reset password", description = "Validates the recovery code and resets the user's password.")
        @ApiResponses({
        ...
        @Operation(summary = "Resend validation email", description = "Sends the email validation message to the provided email.")
        @ApiResponses({
        ...
        @Operation(summary = "Change user password", description = "Changes the user's password using the current and new password.")
        @ApiResponses({
